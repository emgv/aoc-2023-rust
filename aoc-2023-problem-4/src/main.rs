...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let solver = solver::Solver::new(
        file_name_problem1,
        file_name_problem2);
    let problem1_answer = solver.solve_problem1(200000000000000f64, 400000000000000f64)?;
    println!("Problem1 answer: {:?}", problem1_answer);
    
    let problem2_answer = solver.solve_problem2()?;
    println!("Problem2 answer: {:?}", problem2_answer);
